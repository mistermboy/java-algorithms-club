...
public class AVLTreeTest {
	...
	@Test public void inOrderTraversalTest() {
		...
		integerTree.add( 6 );
		integerTree.add( 9 );
		assertEquals( "-3-5-6-7-9-", integerTree.getInOrderTraversal() );

		// Empty tree
		assertEquals( "-", stringTree.getInOrderTraversal() );

		// Only one element
		charTree.add( 'a' );
		assertEquals( "-a-", charTree.getInOrderTraversal() );
	}
	...
	@Test public void postOrderTraversalTest() {
		...
		assertEquals( "--3--6--975", integerTree.getPostOrderTraversal() );

		// Empty tree
		assertEquals( "-", stringTree.getPostOrderTraversal() );

		// Only one element
		charTree.add( 'a' );
		assertEquals( "--a", charTree.getPostOrderTraversal() );
	}
	...
	@Test public void searchReturnTest() throws Exception {
		...
		assertEquals( c.getRootNode().getContent(), c.searchAndReturn( 'b' ) );
		assertEquals( c.getRootNode().getLeft().getContent(), c.searchAndReturn( 'a' ) );
		assertEquals( c.getRootNode().getRight().getContent(), c.searchAndReturn( 'c' ) );
		assertEquals( c.getRootNode().getRight().getRight().getContent(), c.searchAndReturn( 'f' ) );
		System.out.println( "PASSED" );

		// Negative testing
		System.out.print( "Negative testing starting... " );
		assertNotSame( c.getRootNode().getContent(), c.searchAndReturn( 'c' ) );
		assertNotSame( c.getRootNode().getContent(), c.searchAndReturn( 'a' ) );
		assertNotSame( c.getRootNode().getRight().getRight().getContent(), c.searchAndReturn( 'b' ) );
		System.out.println( "PASSED" );
	...
	@Test public void getBFTest() {
		...
		integerTree.add( 4 );
		integerTree.add( 6 );
		assertEquals( 0, integerTree.getRootNode().getBalanceFactor() );
		assertEquals( 0, integerTree.getRootNode().getRight().getBalanceFactor() );
		assertEquals( 0, integerTree.getRootNode().getLeft().getBalanceFactor() );
	...
	@Test public void rotationsTest() {
		...
		a.add( 'd' );
		a.add( 'e' );
		System.out.println( a.getRootNode().getRight() );
	...
	@Test public void getHeightTest() {
		...
		assertEquals( 0, charTree.getHeight() ); // A tree with only one node has
		// also height 0.
		charTree.add( 'b' ); // We add the second element.
		assertEquals( 1, charTree.getHeight() ); // Now the height should be 1.
		charTree.add( 'c' );
		assertEquals( 1, charTree.getHeight() ); // After the third element height
		// should be still one due to
		// rotations.
		charTree.add( 'd' );
		assertEquals( 2, charTree.getHeight() ); // Checking that when more
	...
	@Test public void getNumberOfNodesGreaterThanIterativeTest() {
		// Integers
		// Testing with no elements so an exception should be thrower.
		try {
			integerTree.getNumberOfNodesGreaterThanIterative( 1 );
		...
		assertEquals( 0, integerTree.getNumberOfNodesGreaterThanIterative( 20 ) );

		// Testing with one elements and condition lower than the current value.
		// Expected one element.
		assertEquals( 1, integerTree.getNumberOfNodesGreaterThanIterative( 19 ) );
		...
		try {
			stringTree.getNumberOfNodesGreaterThanIterative( "a" );
			fail( "An exception should be throwed because the tree is empty." );
		} catch (Exception e) {
			System.out.println( e );
		}
		...
		// One element and condition bigger than the actual value.
		// Expected no elements.
		assertEquals( 0, stringTree.getNumberOfNodesGreaterThanIterative( "b" ) );

		// Testing with one elements and condition lower than the current value.
		// Expected one element.
		assertEquals( 1, stringTree.getNumberOfNodesGreaterThanIterative( "a" ) );
	...
	@Test public void getNumberOfNodesGreaterThanTest() {
		// Integers
		// Testing with no elements so an exception should be thrower.
		try {
			integerTree.getNumberOfNodesGreaterThanIterative( 1 );
		...
		// One element and condition bigger than the actual value.
		// Expected no elements.
		assertEquals( 0, integerTree.getNumberOfNodesGreaterThan( 20 ) );

		// Testing with one elements and condition lower than the current value.
		// Expected one element.
		assertEquals( 1, integerTree.getNumberOfNodesGreaterThan( 19 ) );
		...
		integerTree.add( 24 );
		integerTree.add( 18 );
		assertEquals( 5, integerTree.getNumberOfNodesGreaterThan( 17 ) );
	}
